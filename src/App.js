      ...
      <div style={{ display: "flex", maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        ...
        <main style={{ flex: 1, padding: "48px 0 48px 52px", maxWidth: 780 }}>
          ...
          <section id="wp-tiers">
            ...
            <WpTable headers={["Tier", "Monthly Earning", "INR Equivalent*"]} rows={[["Citizen", "~1,000 $VOIZ", "~₹800"], ["Contributor", "~3,750 $VOIZ", "~₹3,000"], ["Insider", "~15,000 $VOIZ", "~₹12,000"], ["Insider + Staking", "~20,000+ $VOIZ", "~₹16,000+"]]} />
...
const SQ = {
  s1: [{ q: "How often do you buy sneakers?", o: ["Monthly", "Every 3 months", "Every 6 months", "Yearly"] }, { q: "What matters most?", o: ["Brand", "Comfort", "Style", "Price"] }, { q: "Where do you shop?", o: ["Online", "Physical store", "Both", "Second-hand"] }, { q: "Your budget?", o: ["Under ₹2K", "₹2K–₹5K", "₹5K–₹15K", "₹15K+"] }],
  ...
  s3: [{ q: "How often do you upgrade your phone?", o: ["Every year", "Every 2 years", "Every 3+ years", "When it breaks"] }, { q: "What triggers an upgrade?", o: ["New features", "Better camera", "Battery issues", "Phone damage"] }, { q: "Preferred brand?", o: ["Samsung", "Apple", "OnePlus", "Other"] }, { q: "Budget?", o: ["Under ₹15K", "₹15K–₹30K", "₹30K–₹60K", "₹60K+"] }, { q: "Most important spec?", o: ["Camera", "Battery", "Performance", "Display"] }, { q: "Where do you buy?", o: ["Online", "Brand store", "Retail", "Second-hand"] }],
